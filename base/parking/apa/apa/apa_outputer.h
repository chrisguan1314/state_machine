...
namespace parking
{
    ...
    private:
        ...
        void ActionOverride(std::shared_ptr<ApaParam>, std::shared_ptr<ApaInputer>, std::shared_ptr<ApaStateSwitcher>) 
        { 
            std::cout << "ApaOutputer Action : OVERRIDE" << std::endl; 
        }
        void ActionSuccess(std::shared_ptr<ApaParam>, std::shared_ptr<ApaInputer>, std::shared_ptr<ApaStateSwitcher>)
        { 
            std::cout << "ApaOutputer Action : SUCCESS" << std::endl; 
        }
        void ActionFailed(std::shared_ptr<ApaParam>, std::shared_ptr<ApaInputer>, std::shared_ptr<ApaStateSwitcher>) 
        { 
            std::cout << "ApaOutputer Action : FAILED" << std::endl; 
        }
        void ActionTerminate(std::shared_ptr<ApaParam>, std::shared_ptr<ApaInputer>, std::shared_ptr<ApaStateSwitcher>) 
        { 

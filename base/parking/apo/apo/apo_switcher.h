...
namespace parking
{
    ...
    class ApoStateSwitcher : public StateMachineSwitcher<ApoStateType>
    {
    private:
    ...
    public:
        void Init() override
        {
            AddStateSwitch(ApoStateType::IDLE_0, {{ApoStateType::STANDBY_1, std::bind(&ApoStateSwitcher::SwitchFromIdleToStandby, this)}});
            AddStateSwitch(ApoStateType::STANDBY_1, {{ApoStateType::IDLE_0, std::bind(&ApoStateSwitcher::SwitchFromStandbyToIdle, this)},
                                                     {ApoStateType::PREPARING_2, std::bind(&ApoStateSwitcher::SwitchFromStandbyToPreparing, this)}});
            AddStateSwitch(ApoStateType::PREPARING_2, {{ApoStateType::PREPARED_3, std::bind(&ApoStateSwitcher::SwitchFromPreparingToPrepared, this)},
            ...
            AddStateSwitch(ApoStateType::PARKING_4, {{ApoStateType::SUSPEND_5, std::bind(&ApoStateSwitcher::SwitchFromParkingToSuspend, this)},
            ...
            AddStateSwitch(ApoStateType::SUSPEND_5, {{ApoStateType::PARKING_4, std::bind(&ApoStateSwitcher::SwitchFromSuspendToParking, this)},
        ...
        virtual void Print() const override
        {
            ...
            {
                if (GetCrntState() >= ApoStateType::PREPARING_2)
                {
